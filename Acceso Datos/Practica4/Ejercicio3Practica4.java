...
public class Ejercicio3Practica4 {
    public static void main(String[] args) {
        try {
            ...
            System.out.println("Número de empleados y media de salario redondeada por departamento:");
            for (String deptNo : empleadosPorDepartamento.keySet()) {
                ...
                System.out.println("Media de salario redondeada: " + Math.round(mediaSalarios));
                System.out.println("------");
            }
